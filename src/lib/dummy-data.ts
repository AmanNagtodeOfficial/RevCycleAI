...
const SAMPLE_IMG_URL = 'https://picsum.photos/seed/docpreview/800/600';
...
export const patientDocuments: Omit<PatientDocument, 'id' | 'dateUploaded'>[] & { id: string, dateUploaded: string }[] = [
    ...
    { id: 'doc-2', patientId: 'patient-1', name: 'Aetna Insurance Card.png', category: 'Insurance Card', dateUploaded: '2024-07-10', url: SAMPLE_IMG_URL, practiceId: 'practice-test' },
    { id: 'doc-3', patientId: 'patient-2', name: 'BCBS ID Card.jpg', category: 'Insurance Card', dateUploaded: '2024-06-25', url: SAMPLE_IMG_URL, practiceId: 'practice-test' },
    ...
    { id: 'doc-6', patientId: 'patient-7', name: 'Cigna Verification.png', category: 'Insurance Card', dateUploaded: '2024-07-18', url: SAMPLE_IMG_URL, practiceId: 'practice-2' },
